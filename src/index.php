    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5">
                ...
                $rows = $client->executeQuery("carsDB.cars", $query);
                ...
                foreach ($rows as $car) {
                    echo '<div class="col-md-4 mb-5">';
                        echo '<div class="card h-100">';
                            ...
                            echo '</div>';
                            if ($isAdmin){
                                echo '<div class="card-footer"><a class="btn btn-primary btn-sm" href="edit.php?id='.$car->_id . '">Edit</a></div>';
                                echo '<div class="card-footer"><a class="btn btn-primary btn-sm" href="delete.php?id='.$car->_id . '">Delete</a></div>';
                            }
                            echo '</div>';
                    echo '</div>';
                }
